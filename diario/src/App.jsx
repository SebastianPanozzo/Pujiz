...
import { EditNewsContent } from './components/EditNewsContent';  // Importación corregida
import NewsDetailPage from './components/NewsDetailPage'; // Importa el nuevo componente de detalles
    ...
    <UserProvider>
      <BrowserRouter>
        ...
        <Routes>
          ...
          <Route path="/edit-content/:id" element={<EditNewsContent />} />  {/* Ruta corregida */}
          <Route path="/noticia/:id" element={<NewsDetailPage />} /> {/* Ruta para los detalles */}
          <Route path="/seccion/:sectionName" element={<SectionPage />} /> {/* Ruta dinámica */}
